...
var DateContainer = function DateContainer(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (moment__WEBPACK_IMPORTED_MODULE_3___default()(startDate).isBefore(min) || moment__WEBPACK_IMPORTED_MODULE_3___default()(endDate).isAfter(max)) {
      console.log(moment__WEBPACK_IMPORTED_MODULE_3___default()(startDate).isBefore(min), moment__WEBPACK_IMPORTED_MODULE_3___default()(endDate).isAfter(max));
      addToast(__jsx("div", {
        __self: _this,
        __source: {
...
//# sourceMappingURL=_app.js.6e8aba3915246f1f2dc9.hot-update.js.map