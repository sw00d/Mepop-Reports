...
var DateContainer = function DateContainer(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    setTimeout(function () {
      if (allData.sales && dateRange.startDate && dateRange.endDate) {
        var rangedData = Object(_dataProcessing_utils__WEBPACK_IMPORTED_MODULE_8__["getRangedData"])(allData, {
  ...
  return __jsx(_styles_layout_Flex__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    endDate: dateRange.endDate ? moment__WEBPACK_IMPORTED_MODULE_3___default()(fixedFullRange ? max : dateRange.endDate) : null // disabled={fixedFullRange}
    ,
    isOutsideRange: function isOutsideRange(day) {
      return false; // return (day.isBefore(moment(min)) || day.isAfter(moment(max)))
    },
    enableOutsideDays: true // onDatesChange={({ startDate, endDate }) => {
...
//# sourceMappingURL=_app.js.a70818f62958c4afd5c8.hot-update.js.map