...
var DateContainer = function DateContainer(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (startDate.isBefore(min) || endDate.isAfter(max)) {
      addToast;
    }
  ...
  return __jsx(_styles_layout_Flex__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    disabled: fixedFullRange // isOutsideRange={() => false}
    // enableOutsideDays
    ,
...
_s(DateContainer, "mfvaUAOM761duk5g9Jn+bTpHyl8=", true, function () {
...
//# sourceMappingURL=_app.js.76caae26a9879a6dddd6.hot-update.js.map